...
- signup on AWS
- aws console search EC2 (elastic compute) , EC2 > Launch Instance > Launch an instance
- download the pem file, 
- launch instance
- go to instance details and connect, use SSH client, open terminal , cd Downloads
- modify the permission using chmod 400 <secret>.pem
- connect your terminal with aws using pem file like ssh -h "devTinder..." ubunty@*******.amazonaws.com
